...
with open("App/01_System_Architecture.md", "w") as f:
    f.write("""# 01. System Architecture & Logical Boundaries
...
* **The Next.js Web App:** Built using React and Tailwind CSS, hosted on Vercel. Connects to Firebase RTDB over WebSockets. Renders real-time telemetry gauges, interactive threshold sliders, historical charts, and the AI chatbot terminal.
...
This document outlines the step-by-step transaction workflow. It outlines what happens first, what happens next, who sends the data, who receives it, what format it is in, and what validations are performed.
