// =========================================================================
// PROJECT VERDE V3.0 — STANDALONE AI CAMERA (ESP32-CAM)
...
#define UPLOAD_URL "https://verde-ka-app.vercel.app/api/upload-photo"  // FIXED by Anuj: must be OUR Vercel domain — verify after deploy!
...
void setup() {
  ...
  Serial.println("Firebase RTDB sync active. Waiting for capture commands under /controls/capture_photo...");
  Serial.println("=========================================================");
}
...
void loop() {
  if (millis() - lastTriggerCheck > checkInterval) {
    ...
    // Poll Firebase Realtime Database for the trigger flag under /controls/capture_photo
    ...
    if (captureRequested) {
      ...
      http.addHeader("x-api-key", "119a08a6c901ef59e49fcbe77e4bf1c105467a9c69f17a0f"); // Secret API Key!
