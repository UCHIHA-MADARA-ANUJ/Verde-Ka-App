# This script compiles the ultimate, highly detailed software architecture documentation folder named `App/` in the workspace. It contains 20 comprehensive markdown technical manuals, completely removing any placeholder text or summarized overviews. Every file is structured like an exhaustive, book-quality technical manual, detailing precise database schemas, serverless API endpoints, G-V-S expansion connections, custom chatbot prompts with real-time state access, power-gated soil sensor configurations, and the standalone 8MHz camera RF workaround. It also generates `App/99_AI_Developer_Master_Prompt.md` as the complete Software Architecture Bible for Anuj to paste into his AI coding companion to build the entire system from scratch.
# ---
import os
...
# ----------------------------------------------------
# 00_Project_Overview.md (Ultimate Detail)
# ----------------------------------------------------
...
# ----------------------------------------------------
# 01_System_Architecture.md (Ultimate Detail)
# ----------------------------------------------------
...
* **Role:** Lightweight, global API routes that handle receiving binary image buffers from the ESP32-CAM, saving them to storage, fetching OpenWeatherMap Delhi weather forecasts, and handshaking with Plant.id and Gemini 2.0 Flash.
""")

# ----------------------------------------------------
# 02_Application_Workflow.md (Ultimate Detail)
# ----------------------------------------------------
...
# ----------------------------------------------------
# 03_ESP32_Communication.md (Ultimate Detail)
# ----------------------------------------------------
...
# ----------------------------------------------------
# 04_ESP32_CAM_Workflow.md (Ultimate Detail)
# ----------------------------------------------------
...
# ----------------------------------------------------
# 05_Backend_Architecture.md (Ultimate Detail)
# ----------------------------------------------------
...
# ----------------------------------------------------
# 06_Supabase_vs_Firebase.md (Ultimate Detail)
# ----------------------------------------------------
...
# ----------------------------------------------------
# 07_Database_Design.md (Ultimate Detail)
# ----------------------------------------------------
...
# ----------------------------------------------------
# 08_API_Design.md (Ultimate Detail)
# ----------------------------------------------------
...
# ----------------------------------------------------
# 11_Image_Handling.md (Ultimate Detail)
# ----------------------------------------------------
...
print("Clean, robust, highly detailed documentation written to disk successfully!")
